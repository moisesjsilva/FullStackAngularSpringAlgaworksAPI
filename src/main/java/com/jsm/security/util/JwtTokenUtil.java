...
public class JwtTokenUtil {
	...
	static final String CLAIM_KEY_ROLE = "authorities";
	static final String CLAIM_KEY_CREATED = "created";
	static final String CLAIM_KEY_USER_FOTO="foto";
	...
	public String obterToken(UserDetails userDetails) {
		...
		//5
		//userDetails.getAuthorities().forEach(authority -> claims.put(CLAIM_KEY_ROLE, authority));
		//claims.put(CLAIM_KEY_ROLE,userDetails.getAuthorities().toArray());
		List<String> lista = new ArrayList<>();
		userDetails.getAuthorities().forEach(u -> lista.add(u.getAuthority()));
		
		claims.put(CLAIM_KEY_ROLE,lista.toArray());
		claims.put(CLAIM_KEY_USER_FOTO,((JwtUser)userDetails).getFoto());
